...
pub fn Collapsible(mut props: prim::CollapsibleProps) -> Element {
    props.attributes.push(Attribute::new("class", "collapsible", None, false));
...
pub fn CollapsibleTrigger(mut props: prim::CollapsibleTriggerProps) -> Element {
    props.attributes.push(Attribute::new("class", "collapsible-trigger", None, false));
...
pub fn CollapsibleContent(mut props: prim::CollapsibleContentProps) -> Element {
    props.attributes.push(Attribute::new("class", "collapsible-content", None, false));
