...
pub fn HoverCard(mut props: prim::HoverCardProps) -> Element {
    props.attributes.push(Attribute::new("class", "cyber-hover-card", None, false));
...
pub fn HoverCardTrigger(mut props: prim::HoverCardTriggerProps) -> Element {
    props.attributes.push(Attribute::new("class", "cyber-hover-card-trigger", None, false));
...
pub fn HoverCardContent(mut props: prim::HoverCardContentProps) -> Element {
    props.attributes.push(Attribute::new("class", "cyber-hover-card-content", None, false));
